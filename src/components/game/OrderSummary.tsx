...
import { type Game, type GameProduct, type Voucher } from '@/types'
import { formatCurrency } from '@/lib/utils'
import { Gamepad2, Tag, Percent, ArrowRight } from 'lucide-react'
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/50">{product.label}</p>
          </div>
        </div>
  ...
  return (
    <div className="flex items-center gap-3 p-3 bg-dark-100 rounded-xl">
      ...
      <div className="flex-1 min-w-0">
        <p className="font-medium text-white text-sm truncate">{product.label}</p>
